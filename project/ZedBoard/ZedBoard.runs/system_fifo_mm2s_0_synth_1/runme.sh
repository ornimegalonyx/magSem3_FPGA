...
HD_PWD='C:/work/miet/mag_sem_3/magSem3_FPGA/project/ZedBoard/ZedBoard.runs/system_fifo_mm2s_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_fifo_mm2s_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_fifo_mm2s_0.tcl
