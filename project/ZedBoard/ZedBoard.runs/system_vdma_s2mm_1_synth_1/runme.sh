...
HD_PWD='C:/work/miet/mag_sem_3/magSem3_FPGA/project/ZedBoard/ZedBoard.runs/system_vdma_s2mm_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_vdma_s2mm_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_vdma_s2mm_1.tcl
